# -*- coding: utf-8 -*-
"""
Created on Sat Jan  9 18:25:00 2021
...
def load_csv_file():
    #file_csv=pd.read_csv('day_active_learning_to_be_applied.csv')
    file_csv=pd.read_csv('month_clean.csv')
    return file_csv
...
#data_f.to_csv('day_labelled.csv')
data_f.to_csv('month_clean_tolabel.csv')